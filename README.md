...
本项目探索自训练智能体在六自由度飞行仿真中能达到的水平——从模仿脚本教师到完全自博弈的策略，全部集成在单一代码库中，并通过契约固定的观察/动作 schema 保证一致性。
...
核心算法（观察/奖励设计、截断策略）与整体系统架构由作者自主设计。工程实现由 AI 编程智能体（Hermes、Codex 等）辅助。
